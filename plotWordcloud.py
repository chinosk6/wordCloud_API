...
def draw_text(wc, groupnum:str, groupname:str):
    ...
    draw.text(xy=(int(18*1.5), int(1154*1.5)),text = "Generated By Chieri Bot", fill=(202, 80, 163),font=font)

    pt.save('./Images/' + groupnum + '.jpg', quality = 100)

def generate_wordcloud(text, groupnum:str, groupname:str):

    d=path.dirname(__file__)
    alice_mask = np.array(Image.open(path.join(d, "Images//chieri_mask.png")))
    ...
    # 生成词云 
    wc.generate(text)
    draw_text(wc, groupnum, groupname)
    # 生成的词云图像保存到本地
